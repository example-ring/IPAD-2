...
<!-- css,font -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/joinTs.css">
...
<script src="${pageContext.request.contextPath}/js/joinTs.js"></script>
		...
		<div class="container">
			<div class="input-form-backgroud row">
				...
				<div style="width: 50px; height: 100px;"></div>
					...
					<div class="container">
						<h1 style="font-weight: bolder;">사이트 이용약관</h1>
					</div>
...
제 1 조 (목적)
본 약관은 HONSULTING이 운영하는 웹 사이트 (http://8181/IPAD)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
...
본 약관은 2017년 07월 1일부터 적용한다.
							...
							<div class="text-end p-3">
								<input type="checkbox" name="autolgn1"
									class="form-check-input"> <label
									class="form-check-label fw-bold">이용약관에
									동의합니다.</label>
							</div>
						</form>
					</div>
...
HONSULTING은(는) 이용자의 개인정보를 중요하게 생각하며, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법규를 준수하고 있습니다. 이에 본 개인정보처리방침을 통해 이용자들이 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있는지에 대해 안내합니다.

1. 수집하는 개인정보 항목
회원 가입 시: 아이디, 비밀번호, 이메일 주소
서비스 이용 중: 접속 IP 정보, 쿠키, 서비스 이용 기록
2. 개인정보 수집 목적
[회사/사이트 이름]은 다음과 같은 목적으로 개인정보를 수집 및 이용합니다.

회원 관리 및 서비스 제공
서비스 개선 및 유지보수
고객문의에 대한 응답
3. 개인정보의 보유 및 이용 기간
[회사/사이트 이름]은 개인정보 수집 및 이용 목적이 달성된 후에는 지체 없이 파기합니다. 단, 관련 법령에 의해 보존하여야 하는 경우에는 해당 법령에 따라 보존합니다.

4. 개인정보의 제3자 제공
[회사/사이트 이름]은 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 다만, 다음의 경우에는 예외로 합니다.

이용자 동의가 있는 경우
법령의 규정에 따라 제공이 필요한 경우
5. 개인정보의 처리 위탁
[회사/사이트 이름]은 서비스 향상을 위해 일부 업무를 외부에 위탁할 수 있으며, 이 경우에는 위탁 받는 자와의 사전 계약 체결 및 관리, 수탁자에 대한 감독을 진행하고 있습니다.

6. 개인정보 보호책임자
[회사/사이트 이름]은 개인정보 보호책임자를 지정하여 개인정보 관리 및 보호에 최선의 노력을 다하고 있습니다.

성명: [보호책임자 성명]
연락처: [보호책임자 연락처]
이메일: [보호책임자 이메일]
7. 개인정보처리방침 변경 공지
개인정보처리방침이 변경될 경우, 변경 사항을 시스템 화면에 게시하며, 필요 시 이용자에게 전자우편 등의 방법으로 공지하겠습니다.

본 개인정보처리방침은 2024.01.15에 최종 변경되었습니다.
                            </textarea>
							</div>
							<div class="text-end p-3">
								<input type="checkbox" name="autolgn2"
									class="form-check-input "> <label
									class="form-check-label  fw-bold">개인정보 수집 및
									이용에 동의합니다.</label>
							</div>
						</form>
					</div>
					...
					<div class="text-center m-3 ">
						<button type="submit" id="okagree" class="btn btn-light" >
							<i class="bi bi-check"></i>모두 동의합니다
						</button>
						<button id="noagree" class="btn btn-light">
							<i class="bi bi-x"></i><a href="${pageContext.request.contextPath}/main.do">모두 동의하지 않습니다</a>
						</button>
					</div>
